...
/* Codigo: Leitores e escritores usando  Java | Atividade 6*/
/* Aluno: Paulo Yamagishi DRE: 121072893 */
/* -------------------------------------------------------------------*/
...
class LE {
  ...
  LE() { 
     this.leit = 0;
     this.escr = 0;
     this.p_escr = 0; // Potenciais escritores
  } 
  
  // Entrada para leitores
  public synchronized void EntraLeitor (int id) { 
    try { 
      while (this.escr > 0 || this.p_escr > 0) {
